...
export default function GlobalError({ error, reset }) {
  ...
  return (
    <div className="flex h-[calc(100vh-135px)] flex-col items-center justify-center text-center px-4">
      <div className="flex flex-col items-center bg-white rounded-2xl p-10 text-center">
        ...
        <button
          className=" cursor-pointer rounded-lg px-2 py-1 border text-black hover:bg-black/10"
          onClick={() => reset()}
        >
          Retry
        </button>
